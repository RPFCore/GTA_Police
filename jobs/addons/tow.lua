...
RegisterNetEvent('rpf:spawnTow')
RegisterNetEvent('rpf:cancelTow')
...
onscene = false
cleartask = false
AddEventHandler( 'rpf:spawnTow', function()
		...
		while (enroute) do
			...
			SetEntityInvincible(driver, true)
				if distanceToVeh <= 15 then
					...
					Wait(3000)
					AttachEntityToEntity(targetVeh, tow, 20, -0.5, towOffset, 0.0, 0.0, 0.0, 0.0, false, false, false, false, 2, true)
...
AddEventHandler( 'rpf:cancelTow', function()
